resource "yandex_kubernetes_cluster" "zonal_k8s_cluster" {
  ...
  depends_on = [
    yandex_resourcemanager_folder_iam_member.k8s-cluster-agent-permissions,
    yandex_resourcemanager_folder_iam_member.vpc-publicAdmin-permissions,
    yandex_resourcemanager_folder_iam_member.load-balancer-admin-permissions,
    yandex_resourcemanager_folder_iam_member.k8s-node-group-permissions,
  ]
}
