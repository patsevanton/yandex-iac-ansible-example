...
resource "yandex_storage_bucket" "opensearch" {
  ...
  bucket     = "opensearch-anton-patsev"
  force_destroy = true
}

output "access_key_sa_storage_admin_for_test_bucket" {
  description = "access_key sa-storage-admin for opensearch"
  value       = yandex_storage_bucket.opensearch.access_key
  sensitive   = true
}

output "secret_key_sa_storage_admin_for_test_bucket" {
  description = "secret_key sa-storage-admin for opensearch"
  value       = yandex_storage_bucket.opensearch.secret_key
  sensitive   = true
}
